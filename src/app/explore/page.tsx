...
const Page = () => {
  return (
    <section className="bg-white dark:bg-gray-900 mx-auto my-auto mt-[50]px">
    <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">Our Developers are working in night to cover up fast.</p>
    </div>
    <Footer/>
</section>
  )
